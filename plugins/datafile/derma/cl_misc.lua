...
function PANEL:Init()
	...
	self.Entry = vgui.Create("ixDfDTextEntry", self)
	...
	self.Submit = vgui.Create("ixDfButton", self)
...
vgui.Register("ixDfCivilEntry", PANEL, "DFrame")
...
vgui.Register("ixDfMedicalEntry", PANEL, "DFrame")
...
vgui.Register("ixDfNoteEntry", PANEL, "DFrame")
...
vgui.Register("ixDfDTextEntry", PANEL, "DTextEntry")
