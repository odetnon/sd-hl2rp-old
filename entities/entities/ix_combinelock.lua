...
function ENT:SetupDataTables()
	...
	self:NetworkVar("Int", 0, "LockMode")
...
if (SERVER) then
	...
	function ENT:Toggle(client)
		...
		if ((!client:IsCombine() and client:Team() != FACTION_CAB) and (self:GetLockMode() == 2 and (!client:Team() != FACTION_CWU)) and (self:GetLockMode() == 3 and (!table.HasValue(client:GetItems(), "union_card")))) then
			self:DisplayError()
